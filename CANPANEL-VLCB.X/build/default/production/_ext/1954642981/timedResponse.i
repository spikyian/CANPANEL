...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/timedResponse.c" 2
# 28 "../../VLCBlib_PIC/timedResponse.c"
...
# 28 "../../VLCBlib_PIC/timedResponse.c" 2
...
extern ValidTime APP_isSuitableTimeToWriteFlash(void);
# 29 "../../VLCBlib_PIC/timedResponse.c" 2
...
# 31 "../../VLCBlib_PIC/timedResponse.c" 2
# 64 "../../VLCBlib_PIC/timedResponse.c"
...
void startTimedResponse(uint8_t type, uint8_t serviceIndex, TimedResponseResult (*callback)(uint8_t type, uint8_t si, uint8_t step)) {
    ...
    if (serviceIndex == 0) {
        ...
        if ((serviceIndex < 1) || (serviceIndex > 9)) {
...
void pollTimedResponse() {
    ...
    if (timedResponseType == 0xFF) {

        return;
    }
    if (timedResponseCallback == ((void*)0)) {
    ...
    switch (result) {
        case TIMED_RESPONSE_RESULT_FINISHED:
            ...
            if (timedResponseAllServicesFlag) {
                ...
                if (timedResponseServiceIndex >= 9) {
