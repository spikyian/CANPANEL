...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/messageQueue.c" 2
# 47 "../../VLCBlib_PIC/messageQueue.c"
...
# 47 "../../VLCBlib_PIC/messageQueue.c" 2
...
extern ValidTime APP_isSuitableTimeToWriteFlash(void);
# 48 "../../VLCBlib_PIC/messageQueue.c" 2
...
Qresult push(MessageQueue * q, Message * m) {
    if (((q->writeIndex+1)&((q->size)-1)) == q->readIndex) return QUEUE_FAIL;
...
Message * getNextWriteMessage(MessageQueue * q) {
    uint8_t wr;
    if (((q->writeIndex+1)&((q->size)-1)) == q->readIndex) return ((void*)0);
    wr = q->writeIndex;
    q->writeIndex++;
    if (q->writeIndex >= q->size) q->writeIndex = 0;
...
Message * peek(MessageQueue * q, uint8_t index) {
    ...
    if (index == q->writeIndex) return ((void*)0);
