...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/boot.c" 2
# 40 "../../VLCBlib_PIC/boot.c"
...
const uint8_t paramBlock[] __attribute__((address(0x820))) = {
    ...
    0,
    0,
    ((MANU_MERG+'a'+MTYP_CANPanel+255 +20 +(8 + 64)+2 +(8) +P18F26K80+(8)+CPUM_MICROCHIP+1 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN)&0xFF),
    ((MANU_MERG+'a'+MTYP_CANPanel+255 +20 +(8 + 64)+2 +(8) +P18F26K80+(8)+CPUM_MICROCHIP+1 +(20)+(0x48)+(0x08)+1 +2 +PB_CAN)>>8)
};
