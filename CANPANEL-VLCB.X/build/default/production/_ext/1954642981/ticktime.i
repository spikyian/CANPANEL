...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/ticktime.c" 2
# 80 "../../VLCBlib_PIC/ticktime.c"
...
void initTicker(uint8_t priority) {
    ...
    for (i=64;i>0;i>>=1)
        divider++;
# 122 "../../VLCBlib_PIC/ticktime.c"
    T0CON1bits.CKPS = (uint8_t)(0b00000000 | (divider+1));
    T0CON0bits.MD16 = 1;
    T0CON1bits.CS = 2;
    TMR0H = 0;
    TMR0L = 0;
    TMR0IP = (__bit)priority;
    TMR0IF = 0;
    TMR0IE = 1;
    T0CON0bits.EN = 1;
    ...
    timerExtension1 = 0;
    timerExtension2 = 0;
# 147 "../../VLCBlib_PIC/ticktime.c"
}
# 158 "../../VLCBlib_PIC/ticktime.c"
uint32_t tickGet(void) {
...
void __attribute__((picinterrupt(("irq(TMR0), base(0x900)")))) TMR0_ISR(void)
{
