# 1 "../../VLCBlib_PIC/event_acknowledge.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/event_acknowledge.c" 2
# 42 "../../VLCBlib_PIC/event_acknowledge.c"
...
# 42 "../../VLCBlib_PIC/event_acknowledge.c" 2
...
# 45 "../../VLCBlib_PIC/event_acknowledge.c" 2
...
# 46 "../../VLCBlib_PIC/event_acknowledge.c" 2
# 57 "../../VLCBlib_PIC/event_acknowledge.c"
...
static DiagnosticVal ackDiagnostics[1];
# 71 "../../VLCBlib_PIC/event_acknowledge.c"
...
static Processed ackEventProcessMessage(Message * m) {
    ...
    if (findService(SERVICE_ID_CONSUMER) == ((void*)0)) {
        return NOT_PROCESSED;
    }
    if (m->len < 5) {
        return NOT_PROCESSED;
