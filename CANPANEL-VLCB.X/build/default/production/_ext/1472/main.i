...
# 78 "../../VLCBlib_PIC\\event_consumer_simple.h"
...
# 172 "../main.c"
    ...
    setTimedResponseDelay((uint8_t)getNV(6));
    panelEventsInit();
...
void loop(void) {
    ...
    if (!started && ((tickGet() - startTime.val) > (getNV(1) * (62500/10)) + (62500*2))) {
        started = TRUE;
        sendProducedEvent((64 + 1), EVENT_ON);
    }

    if (started) {
        if ((tickGet() - lastInputScanTime.val) > 10*(62500/1000)) {
