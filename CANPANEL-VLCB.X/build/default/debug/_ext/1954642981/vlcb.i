...
void sendMessage(VlcbOpCodes opc, uint8_t len, uint8_t data1, uint8_t data2, uint8_t data3, uint8_t data4, uint8_t data5, uint8_t data6, uint8_t data7) {
    ...
    if (transport != ((void*)0)) {
        if (transport->sendMessage != ((void*)0)) {
