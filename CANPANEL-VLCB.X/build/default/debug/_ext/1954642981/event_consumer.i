# 1 "../../VLCBlib_PIC/event_consumer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/event_consumer.c" 2
# 42 "../../VLCBlib_PIC/event_consumer.c"
...
# 42 "../../VLCBlib_PIC/event_consumer.c" 2
...
extern ValidTime APP_isSuitableTimeToWriteFlash(void);
# 43 "../../VLCBlib_PIC/event_consumer.c" 2
...
extern void deleteActionRange(uint16_t action, uint8_t number);
# 44 "../../VLCBlib_PIC/event_consumer.c" 2
...
# 45 "../../VLCBlib_PIC/event_consumer.c" 2
# 58 "../../VLCBlib_PIC/event_consumer.c"
static DiagnosticVal consumerDiagnostics[1];
...
const Service eventConsumerService = {
    ...
    consumerGetDiagnostic

};


static ActionAndState actionQueue[64];
...
# 111 "../../VLCBlib_PIC/event_consumer.c"
static Processed consumerProcessMessage(Message *m) {
    uint8_t start, end;
    uint8_t tableIndex;
    int8_t change;
...
Boolean pushAction(ActionAndState a) {
    if (((awriter+1)&(64 -1)) == areader) return FALSE;
    actionQueue[awriter++] = a;
    if (awriter >= 64) awriter = 0;
    return TRUE;
}
# 221 "../../VLCBlib_PIC/event_consumer.c"
...
void deleteActionRange(uint16_t action, uint8_t number) {
    uint8_t tableIndex;
