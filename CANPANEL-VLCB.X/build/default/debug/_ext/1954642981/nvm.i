...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/nvm.c" 2
# 75 "../../VLCBlib_PIC/nvm.c"
...
extern ValidTime APP_isSuitableTimeToWriteFlash(void);
# 76 "../../VLCBlib_PIC/nvm.c" 2

# 1 "../../VLCBlib_PIC/hardware.h" 1
# 77 "../../VLCBlib_PIC/nvm.c" 2
...
# 495 "../../VLCBlib_PIC/nvm.c"
    if ((index&(~((flash_address_t)(256U)-1))) != flashBlock) {
        ...
        flashBlock = (index&(~((flash_address_t)(256U)-1)));
        loadFlashBlock();
    }
    flashFlags.eraseNeeded |= (value & ~flashBuffer[(index&((256U)-1))])?1:0;
    if (flashBuffer[(index&((256U)-1))] != value) {
        flashFlags.writeNeeded = 1;
        flashBuffer[(index&((256U)-1))] = value;
    }
    return GRSP_OK;
}
