...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/statusLeds2.c" 2
# 40 "../../VLCBlib_PIC/statusLeds2.c"
...
void leds_powerUp(void) {
    ...
    {ANSELA=ANSELB=0; TRISBbits.TRISB6=TRISBbits.TRISB7=0,TRISAbits.TRISA2=1;};
    flashCounter[0] = 0;
    flashCounter[1] = 0;
...
void leds_poll(void) {
    if ((tickGet() - ledTimer.val) > (62500/100)) {
        flashCounter[0]++;
        flashCounter[1]++;
        ledTimer.val = tickGet();
    }
    ...
    switch (ledState[1]) {
        ...
        case LED_FLASH_50_2HZ:
            ...
            (LATBbits.LATB6=flashCounter[1]/25);
            if (flashCounter[1] >= 50) {
                flashCounter[1] = 0;
            }
            break;
        case LED_FLASH_50_1HZ:

            (LATBbits.LATB6=flashCounter[1]/50);
            if (flashCounter[1] >= 100) {
                flashCounter[1] = 0;
            }
            break;
        case LED_FLASH_50_HALF_HZ:
            (LATBbits.LATB6=flashCounter[1]/100);
    ...
    switch (ledState[0]) {
        ...
        case LED_FLASH_50_2HZ:
            ...
            (LATBbits.LATB7=flashCounter[0]/25);
            if (flashCounter[0] >= 50) {
                flashCounter[0] = 0;
            }
            break;
        case LED_FLASH_50_1HZ:

            (LATBbits.LATB7=flashCounter[0]/50);
            if (flashCounter[0] >= 100) {
                flashCounter[0] = 0;
            }
            break;
        case LED_FLASH_50_HALF_HZ:
            (LATBbits.LATB7=flashCounter[0]/100);
