...
# 2 "<built-in>" 2
# 1 "../../VLCBlib_PIC/actionQueue.c" 2
# 39 "../../VLCBlib_PIC/actionQueue.c"
# 1 "..\\module.h" 1
# 40 "..\\module.h"
...
# 1 "../panelNv.h" 1
# 41 "..\\module.h" 2
# 39 "../../VLCBlib_PIC/actionQueue.c" 2

# 1 "../../VLCBlib_PIC/actionQueue.h" 1
# 38 "../../VLCBlib_PIC/actionQueue.h"
...
# 38 "../../VLCBlib_PIC/actionQueue.h" 2
...
extern Boolean pushAction(uint16_t a);
extern uint16_t getAction(void);
extern void doneAction(void);
extern uint16_t pullAction(void);
extern uint16_t peekActionQueue(uint8_t index);
extern void deleteActionQueue(uint8_t index);
extern void setExpeditedActions(void);
extern void setNormalActions(void);
# 40 "../../VLCBlib_PIC/actionQueue.c" 2



BYTE normalReadIdx;
BYTE normalWriteIdx;
uint16_t queueBuf[64];
Queue queue;
...
Boolean pushAction(uint16_t a) {
    return push(&queue, a);
}
# 75 "../../VLCBlib_PIC/actionQueue.c"
uint16_t getAction(void) {
...
uint16_t peekActionQueue(uint8_t index) {
